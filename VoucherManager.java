...
/**
 * Quản lý voucher giảm giá đổi từ điểm tích lũy - mô phỏng theo tính năng
 * "Đổi điểm lấy voucher" của hệ thống Rạp Chiếu Phim Mặt Trời Nhỏ.
 *
 * Quy tắc: tối thiểu 50 điểm mới đổi được, phải là bội số của 10 điểm,
 * tỉ lệ đổi: 1 điểm = 1.000đ giảm giá (thấp hơn tỉ lệ tích để hệ thống
 * không bị lỗ, giống nguyên tắc chương trình khách hàng thân thiết thông thường).
 */
public class VoucherManager {
    ...
    /** Đổi soDiem điểm lấy 1 voucher mới cho chủ sở hữu. Không tự trừ điểm - caller lo phần đó. */
    ...
    /** Tra cứu voucher hợp lệ: đúng mã, đúng chủ, chưa dùng. */
